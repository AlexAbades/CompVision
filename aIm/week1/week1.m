...
%We can compyte the derivative of the image by convolvinb with the kernel d
d=[0.5 0 -0.5];
Id=imfilter(I,d); 

%Derivative image convolved by a Gaussian
g3= imfilter(Id,h1); 

%Image convolved with the derivative of the Gaussian
sigma=1;
...
%Test if a single large convolution with a Gaussian of t=20 is equal to 10
%convolutions with a Gaussian of t=2. 
